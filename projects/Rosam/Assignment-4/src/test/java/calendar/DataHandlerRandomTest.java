	...
	for (int i = 0; i < NUM_TESTS; i++) {
					...
					//calday_temp.addAppt(appt);
						...
						if( i % 15 == 0)
						{
							calday_temp.addAppt(appt);
					    appt.valid = false;
						DataHandler_temp.getApptRange(cal,work2);
						DataHandler_temp.save();
						DataHandler_temp.saveAppt(appt);	
						DataHandler_temp.deleteAppt(appt);	
						...
						DataHandler_temp.save();	
						DataHandler_temp.saveAppt(appt);
						DataHandler_temp.deleteAppt(appt);//so the problem with this guy is the appointment is allways going to be valid	
						}
